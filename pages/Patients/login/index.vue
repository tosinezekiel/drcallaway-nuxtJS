                                            ...
                                            <div class="card-body pt-1">
                                                <form action="index.html">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-left">
                                                             <div class="text-right d-sm-block"><a href="#" class="card-link">Forget Password?</a></div>
                                                        </div>
                                                    </div>
                                                   <!--  <a href="index.html" class="btn btn-outline-primary float-left btn-inline">Register</a> -->
                                                    <nuxt-link to="/patients/login" type="submit" id="login" class="btn btn-primary d-block btn-inline">Sign In</nuxt-link>
                                                </form>
